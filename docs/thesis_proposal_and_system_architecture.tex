...
\begin{itemize}
  ...
  \item \path{configs/d_link_day_cam5.json}: dataset paths, categories, training dates, testing dates, precision, and tolerance.
\end{itemize}
...
\begin{itemize}
  ...
  \item The native C-wrapped LM backend is implemented; YS remains absent.
...
\begin{itemize}
  ...
  \item Align \path{configs/d_link_day_cam5.json} with the dates used in the ALM IoT paper.
